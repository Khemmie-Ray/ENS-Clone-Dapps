...
const AvatarUpload = () => {
  ...
  const handleSubmission = async () => {
    try {
      ...
      // Retrieve resData from local storage and set the imageUrl
...
// IpfsHash: "QmShCw1gVgbW79mF1XqYkYjbvHCiBzR3RXgMy61UJYk1AS"
  ...
  return (
      ...
      <section className='lg:w-[30%] md:w-[30%] w-[90%] shadow-xl px-4 py-8 rounded-lg text-center border border-gray-100 mb-4'>
      <h3 className='lg:text-3xl md:text-3xl text-xl mb-4'>Step one</h3>
      <p className='mb-8'>Upload your user avatar</p>
      <Dialog.Root>
        <Dialog.Trigger>
            <Button className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-full px-20 py-6">Upload Avatar</Button>
        </Dialog.Trigger>
    ...
    <section className='lg:w-[30%] md:w-[30%] w-[90%] shadow-xl px-4 py-8 rounded-lg text-center border border-gray-100'>
